...
public interface StructureArraySupplier<T extends Structure> {
         ...
         * The method that accepts a {@link StructureArraySupplier} must define, whether the supplied
         * array should be allocatable, allocated or unallocated.
         * @param size size of the {@link StructureArray} that should be supplied
         * @param elementClazz the elementClass for the array
         * @param creator {@link UStructSupplier UStructSupplier}
