...
public class StandardHtmlElementTypes {
    ...
    public final static @NotNull StandardHtmlElement.Type FORM       =      newNormal("form");
    public final static @NotNull StandardHtmlElement.Type FIELDSET   =      newNormal("fieldset");
    public final static @NotNull StandardHtmlElement.Type DIALOG     =      newNormal("dialog");
